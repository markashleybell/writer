...
private string[] _weakeningPhrases = new[] {
    "i believe",
    "i consider",
    "i don't believe",
    "i don't consider",
...
private Dictionary<string, string[]> _simplifications = new Dictionary<string, string[]> {
...
private string[] _adverbExceptions = new[] {
    "actually",
    "additionally",
    "allegedly",
    "ally",
...
private Dictionary<string, string> _passiveToActiveSubstitutions = new Dictionary<string, string> {
    { "awoken", "awoke" },
    { "beaten", "beat" },
    { "begun", "began" },
    { "bent", "bent" },
